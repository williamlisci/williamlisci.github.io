                        ...
                        <div className={styles.homePage}>
                            <Element name="header">
                                ...
                                <header className={styles.homeHeader}>
                                    ...
                                    <ScrollLink to="blog-content" smooth={true} duration={500}
                            ...
                            <Element name="blog-content">
                                <main id="blog-content" className={styles.blogContent}>
                                    <section>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <a href="https://vi.wikipedia.org/wiki/B%C3%ACnh_%C4%90%E1%BB%8Bnh_(ph%C6%B0%E1%BB%9Dng)"> Bình
                                                    Định Ward</a>,
                                            ...
                                            <li>
                                                Nationality: <a
                                                href="https://en.wikipedia.org/wiki/Vietnamese_people">Vietnamese</a>
                                            </li>
                                        </ul>
                                    </section>
                                    <section>
                                    ...
                                    <section>
                                        <h3>Contact</h3>
                                        <ul>
                                            <li>Links: Reach out to me at X@Y, where X=williamli.sci and Y=gmail.com.
                                            </li>
                                    ...
                                    <section>
                                        ...
                                        <ul>
                                            <li><a href="https://www.youtube.com/watch?v=anWRa7TiXvw">Tìm trật tự trong
                                                sự hỗn loạn</a></li>
                                            <li><a href="https://youtu.be/faaJcXPs-Rc?si=JPxBHxS0kWdGP_Ln">Does Love
                                                Exist?</a></li>
                                        </ul>
                                    </section>
